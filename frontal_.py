...
#face_mesh = mp_face_mesh.FaceMesh(static_image_mode=True, refine_landmarks=True, min_detection_confidence=0.6)
face_mesh = mp_face_mesh.FaceMesh(
    static_image_mode=False,
    max_num_faces=1,
    refine_landmarks=True,           # opsional: iris/lips lebih presisi
    min_detection_confidence=0.8,    # naikkan jika banyak false positive
    min_tracking_confidence=0.5      # naikkan jika tracking sering “lepas”
)
